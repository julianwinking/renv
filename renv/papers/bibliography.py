...
from renv.papers.ingest import _ARXIV_RE, _DOI_RE, _http_get, _library_file
from renv.papers.ingest import add as ingest_add
from renv.research.db import now, row_to_dict
...
def build_references(con: sqlite3.Connection, root, key: str, *, parser: str = "auto") -> dict:
    ...
    """
    from renv.corpus.parse import parse
