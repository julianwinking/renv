...
#   1. Python venv + editable install of the renv package
...
echo "▸ installing the renv package (editable)"
...
./.venv/bin/renv web install ${HTTP_FLAG} "${DOMAIN_ARGS[@]}" "${PASSTHRU[@]}"
